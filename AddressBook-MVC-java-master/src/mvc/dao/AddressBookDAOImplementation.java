     ...
     public void updatePerson(Person person,String name)
     {
         try
       {
           ...
           System.out.println();person.getName();
            String qry="update AddressBook set name='"+person.getName()+"',mob='"+person.getMob()+"',email='"+person.getEmail()+"','"+person.getAddress()+"'where name='"+name+"')";
           st.executeUpdate(qry);
           conn.close();
        }
    ...
    public void getSelectedName(DetailViewPanel detailPanel,String selectedName)
    {
        try {
            ...
            while(rs.next()){
             ...
             detailPanel.setMobile(rs.getString("mod"));
            ...
            conn.close();
                    ...
                    System.out.println("in getselected name ");
